...
void loop() {
  ...
  unsigned int packetSize = 60;  // Define the packet size in bytes (256 bytes per packet)
  //unsigned long targetBitsPerSecond = 4096;  // Target is 2.048 kbps (2 KiB per second)
